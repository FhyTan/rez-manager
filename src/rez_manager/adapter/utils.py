...
def apply_settings_to_rez(settings: AppSettings) -> None:
    ...
    if pkg_cache.enabled:
        ...
        config.override("package_cache_max_variant_days", pkg_cache.max_variant_days)
        config.override("package_cache_space_buffer", pkg_cache.space_buffer_mb * 1024 * 1024)
    else:
